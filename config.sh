...
sed -i -e 's/^plugins=.*$/plugins=(autojump docker-compose git git-flow command-not-found history sudo tig ubuntu zsh-completions zsh-autosuggestions zsh-syntax-highlighting)/g' ~/.zshrc
